  ...
  return (
    <AppLayout>
      <div className="p-6 lg:p-8 space-y-6">
        <PageBreadcrumb items={[{ label: 'Domínio Externo' }, { label: 'Analyzer', href: '/scope-external-domain/analyzer' }, { label: 'Vulnerabilidades Encontradas' }]} /> items={[{ label: 'Domínio Externo' }, { label: 'Analyzer', href: '/scope-external-domain/analyzer' }, { label: 'Vulnerabilidades Encontradas' }]} />]} />
