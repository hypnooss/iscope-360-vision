...
interface EntraIdDonutChartProps {
  title: string;
  icon: LucideIcon;
...
export function EntraIdDonutChart({ title, icon: Icon, segments, centerLabel, centerValue, loading, className }: EntraIdDonutChartProps) {
