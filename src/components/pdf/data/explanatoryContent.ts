...
export const EXPLANATORY_CONTENT: Record<string, ExplanatoryContent> = {
  ...
  'DNS-001': {
    ...
    whatIs: 'Servidores que traduzem o nome do seu domínio para endereços IP.',
    whyMatters: 'Sem nameservers funcionando, seu site, email e todos os serviços do domínio ficam inacessíveis.',
    impacts: [
      'Site completamente inacessível',
      'Emails não são recebidos nem enviados',
      'Todos os serviços online param de funcionar',
    ],
    howToFix: [
      'Acesse o painel do registrador do seu domínio',
      'Verifique se os nameservers estão configurados corretamente',
      'Configure pelo menos 2 nameservers para redundância',
      'Aguarde até 48 horas para propagação global',
    ],
    difficulty: 'low',
    timeEstimate: '15 min',
  ...
  'DNS-002': {
    ...
    whatIs: 'Registro que identifica o servidor DNS principal e informações de contato do domínio.',
    whyMatters: 'O registro SOA é essencial para o funcionamento do DNS e para outros servidores saberem como atualizar informações.',
    impacts: [
      'Problemas de sincronização entre servidores DNS',
      'Dificuldade em diagnosticar problemas de DNS',
      'Possíveis falhas de resolução',
    ],
    howToFix: [
      'Este registro é gerenciado automaticamente pelo provedor DNS',
      'Se houver problemas, entre em contato com seu provedor',
      'Verifique se o email de contato no SOA está correto',
    ],
    difficulty: 'low',
    timeEstimate: '10 min',
  ...
  'DNS-003': {
    friendlyTitle: 'Redundância de DNS',
