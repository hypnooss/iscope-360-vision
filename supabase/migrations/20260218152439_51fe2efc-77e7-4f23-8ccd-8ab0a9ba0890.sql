...
-- 1. Adicionar 'geo_query' ao enum agent_task_type
ALTER TYPE agent_task_type ADD VALUE IF NOT EXISTS 'geo_query';

-- 2. Atualizar rpc_get_agent_tasks para incluir tasks target_type = 'agent' (geo_query)
...
BEGIN
  ...
  FROM (
    ...
    -- geo_query tasks (target_type = 'agent') — blueprint inline vem do payload
    SELECT t.id, t.task_type, t.target_id, t.target_type, t.payload, t.priority, t.expires_at,
      json_build_object(
        'id', t.agent_id,
        'type', 'agent',
