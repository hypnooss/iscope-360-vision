-- Add spo_domain column to m365_tenants
ALTER TABLE public.m365_tenants ADD COLUMN IF NOT EXISTS spo_domain TEXT;
...
-- Update rpc_get_agent_tasks to include spo_domain in M365 target payload
CREATE OR REPLACE FUNCTION public.rpc_get_agent_tasks(p_agent_id uuid, p_limit integer DEFAULT 4)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
