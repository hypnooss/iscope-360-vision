...
-- =============================================
-- 1. Insert Analyzer Blueprint for FortiGate
-- =============================================
...
SELECT 
  dt.id,
  'FortiGate - Analyzer',
  'Blueprint de coleta de logs para análise de segurança (denied traffic, auth, VPN, IPS, config changes)',
  'hybrid',
  '1.0.0',
  true,
  '{
...
WHERE dt.code = 'fortigate' AND dt.is_active = true
LIMIT 1;

-- =============================================
-- 2. Update RPC to select blueprint by task_type
-- =============================================
